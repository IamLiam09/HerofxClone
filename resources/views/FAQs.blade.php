...
@section('content')
    <section>
        ...
        <div>
            <div>
                <h1>
                    Can I change my personal information on my dashboard?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How do I enable Two Factor Authentication (2FA)?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    What type of customer support does HeroFX offer?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How do I know that the funds have reached HeroFX?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How long does it take for a deposit to reach my account?</h1>
            </div>
            <p>If funds are sent from your crypto wallet, they will be credited once they reach the multiple network confirmations. This process can take up to 6 hours and depends on the blockchain network. Once the funds are received, they are instantly and automatically credited to your vault.</p>
        </div>
        <div>
            <div>
                <h1>
                    I have sent funds. Why are they not in my MT4/MT5 account?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    What are my depositing options?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    Can withdrawals be made while trades are still open?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How do I submit a withdrawal?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How long does it take to withdraw?</h1>
            </div>
        ...
        <div>
            <div>
                <h1>
                    How do I become an HeroFX Affiliate?</h1>
            </div>
